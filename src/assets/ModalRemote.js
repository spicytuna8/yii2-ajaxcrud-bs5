 ...
 * @author Spicytuna8 hendra.account@gmail.com
...
function ModalRemote(modalId) {
    ...
    this.addFooterButton = function (label, type, classes, callback) {
        ...
        buttonElm.setAttribute('class', classes === null ? 'btn btn-primary btn-md' : classes);
        buttonElm.innerHTML = label;

        if (classes.includes('btn-default')) {
            buttonElm.setAttribute('data-bs-dismiss', 'modal'); // Bootstrap 5 compatible dismissal
        }
    ...
    function errorRemoteResponse(response) {
        ...
        this.addFooterButton('Close', 'button', 'btn btn-md btn-default', function (button, event) {
            this.hide();
        })
    }
    ...
    this.confirmModal = function (title, message, okLabel, cancelLabel, size, dataUrl, dataRequestMethod, selectedIds) {
        ...
        this.addFooterButton(
            ...
            'submit',
            'btn btn-danger btn-md float-right float-end',
            function (e) {
                var data;
        ...
        this.addFooterButton(
            ...
            'button',
            'btn btn-md btn-secondary float-left float-start',
            function (e) {
                this.hide();
            }
        );
